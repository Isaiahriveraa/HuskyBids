...
const Alert = ({ 
  ...
  const variants = {
    ...
    purple: {
      container: 'bg-uw-purple-50 dark:bg-uw-purple-900/20 border-uw-purple-200 dark:border-uw-purple-700 text-uw-purple-800 dark:text-uw-purple-300',
      icon: (
        <svg className="w-5 h-5 text-uw-purple-500 dark:text-uw-purple-400" fill="currentColor" viewBox="0 0 20 20">
          <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
        </svg>
      ),
    },
    ...
    >
      ...
      {dismissible && (
        <button
          ...
          className="flex-shrink-0 ml-3 inline-flex text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
          aria-label="Dismiss"
        >
